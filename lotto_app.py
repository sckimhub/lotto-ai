...
if full_data and history_info:
    ...
    with tab_home:
        ...
        with st.expander("⚙️ 분석 설정 (모바일 전용)", expanded=False):
            ...
            mb_recent = history_info
            if mb_recent:
                mb_nums = [n for _, nums, _ in mb_recent for n in nums]
                ...
                with st.expander(f"{epsd}회차 — {len(games_list)}게임{suffix}", expanded=(epsd == target_epsd or has_upper_win)):
                    ...
                    for i, game in enumerate(games_list):
                        ...
                        if won_set:
                            ...
                            elif match == 4:               prize_label = "4등 당첨"
                            elif match == 3:               prize_label = "5등 당첨"
                            else:                          prize_label = "낙첨"
